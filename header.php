                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="images/logo.webp" alt="Amazing Ads" height="60">
                            </span>
                            <span class="logo-lg">
                                <img src="images/logo.webp" alt="Amazing Ads" height="70">
                            </span>
                        </a>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        <?php
                            ...
                            $sidebar_size = 0; $sidebar_party = 0; $sidebar_product = 0; $sidebar_order_form = 0; $sidebar_report = 0; $sidebar_estimate = 0; $sidebar_invoice = 0;
                        ...
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    <!-- <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Amazing Ads</span>
    ...
    <div class="app-menu navbar-menu">
        <div class="navbar-brand-box">
            <a href="dashboard.php" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="images/amazing.png" alt="Amazing Ads" height="50">
                </span>
                <span class="logo-lg">
                    <div class="h5 py-3 text-white">Amazing Ads</div>
                </span>
            </a>
                        ...
                        <div class="collapse menu-dropdown" id="creation">
                            <ul class="nav nav-lg flex-column">
                                ...
                                <li class="nav-item" id="party">
                                    <a href="party.php" class="nav-link"><i class="bi bi-dash"></i> Sales Party </a>
                                </li>
                                <?php } ?>
                            </ul>
                        </div>

                                                ...
                                                <?php
                                                    ...
                                                    if(!empty($report_list)) {
                                                        foreach($report_list as $data) {
                                                            ...
                                                            if(!empty($data['splitup_tax']) && $data['splitup_tax'] != $GLOBALS['null_value']) {
                                                            ...
                                                            $zero_value = ""; $five_value = ""; $twelve_value = ""; $eighteen_value = "";  $twenty_eight_value = "";
                                                            $zero_product = ""; $five_product = ""; $twelve_product = "";
                                                            $eighteen_product = ""; $twenty_eight_product = "";
                                                            ...
                                                            if(!empty($splitup_quantity)) {
                                                                for($i=0; $i < count($splitup_quantity); $i++) {
                                                                    ...
                                                                    if($splitup_tax[$i] == '0') {
                                                                        if(!empty($zero_product)) {
                                                                            $zero_product .= "<br>".$splitup_hsn[$i]." :: ".$splitup_quantity[$i];
                                                                        }
                                                                        else {
                                                                            $zero_product = $splitup_hsn[$i]." :: ".$splitup_quantity[$i];
                                                                        }
                                                                        if(!empty($zero_value)) {
                                                                            $zero_value .= "<br>".number_format($splitup_amount[$i], 2);
                                                                        }
                                                                        else {
                                                                            $zero_value = number_format($splitup_amount[$i], 2);
                                                                        }
                                                                    }
                                                                    if($splitup_tax[$i] == '5') {
                                                                        if(!empty($five_product)) {
                                                                            $five_product .= "<br>".$splitup_hsn[$i]." :: ".$splitup_quantity[$i];
                                                                        }
                                                                        else {
                                                                            $five_product = $splitup_hsn[$i]." :: ".$splitup_quantity[$i];
                                                                        }
                                                                        if(!empty($five_value)) {
                                                                            $five_value .= "<br>".number_format($splitup_amount[$i], 2);
                                                                        }
                                                                        else {
                                                                            $five_value = number_format($splitup_amount[$i], 2);
                                                                        }
                                                                    }
                                                                    if($splitup_tax[$i] == '12') {
                                                                        if(!empty($twelve_product)) {
                                                                            $twelve_product .= "<br>".$splitup_hsn[$i]." :: ".$splitup_quantity[$i];
                                                                        }
                                                                        else {
                                                                            $twelve_product = $splitup_hsn[$i]." :: ".$splitup_quantity[$i];
                                                                        }
                                                                        if(!empty($twelve_value)) {
                                                                            $twelve_value .= "<br>".number_format($splitup_amount[$i], 2);
                                                                        }
                                                                        else {
                                                                            $twelve_value = number_format($splitup_amount[$i], 2);
                                                                        }
                                                                    }
                                                                    if($splitup_tax[$i] == '18') {
                                                                    ...
                                                                    if($splitup_tax[$i] == '28') {
                                                                        if(!empty($twenty_eight_product)) {
                                                                            $twenty_eight_product .= "<br>".$splitup_hsn[$i]." :: ".$splitup_quantity[$i];
                                                                        }
                                                                        else {
                                                                            $twenty_eight_product = $splitup_hsn[$i]." :: ".$splitup_quantity[$i];
                                                                        }
                                                                        if(!empty($twenty_eight_value)) {
                                                                            $twenty_eight_value .= "<br>".number_format($splitup_amount[$i], 2);
                                                                        }
                                                                        else {
                                                                            $twenty_eight_value = number_format($splitup_amount[$i], 2);
                                                                        }
                                                                    }
                                                                }
                                                            }
                                                            ...
                                                            <tr class="<?php if($data['cancelled'] == '1'){ ?> text-danger<?php }else{?> text-dark  <?php } ?>">
                                                                ...
                                                                <th>
                                                                    <?php echo $zero_product; ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo $zero_value; ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo $five_product; ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo $five_value; ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo $twelve_product; ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo $twelve_value; ?>
                                                                </th>
                                                                <th>
                                                                ...
                                                                <th>
                                                                    <?php echo $twenty_eight_product; ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo $twenty_eight_value; ?>
                                                                </th>
                                                                <th class="text-end">
                                                                    <?php

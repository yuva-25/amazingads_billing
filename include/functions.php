<?php
	...
	class Functions {
		...
		public function __construct(Basic_Functions $basic_obj, Creation_functions $creation_obj, Billing_functions $billing_obj, Report_functions $report_obj) {
		...
		public function customer_balance_report($bill_company_id,$customer_id, $from_date, $to_date,$filter_bill_type, $group_id, $category_id){
			$list = $this->report_obj->customer_balance_report($bill_company_id,$customer_id, $from_date, $to_date,$filter_bill_type, $group_id, $category_id);
			return $list;
		}
		...
		public function getPaymentReportList($from_date, $to_date, $filter_bill_type, $filter_party_type, $filter_party_id, $payment_mode_id, $bank_id,$filter_group_id,$filter_category_id) {
            $list = $this->report_obj->getPaymentReportList($from_date, $to_date, $filter_bill_type, $filter_party_type, $filter_party_id, $payment_mode_id, $bank_id,$filter_group_id,$filter_category_id);
            return $list;
        }
        ...
        public function getPartyList($row, $rowperpage, $order_column, $order_direction, $search_value, $filter_party_id)
        {
            $result = $this->creation_obj->getPartyList($row, $rowperpage, $order_column, $order_direction, $search_value, $filter_party_id);
            return $result;
        }

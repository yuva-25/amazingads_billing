<?php
	...
	$GLOBALS['site_name_user_prefix'] = $_SERVER['SERVER_NAME']."_amazingads_billing".date("d-m-Y"); $GLOBALS['user_id'] = ""; $GLOBALS['creator'] = "";
	...
	$GLOBALS['secret_key'] = "amazingads_billing_2026"; 
	...
	// Tables
	$table_prefix = "amazingads_billing_";

<?php
	...
	if(isset($_REQUEST['show_party_id'])) { 
        ...
        $country = "India";$state = "";$district = "";$city = "";$party_name = "";$mobile_number = "";$address = "";$pincode = ""; $pincode = ""; $state = "Tamil Nadu"; $identification = ""; $party_type = ""; $district = ""; $city = "";
    ...
    if(isset($_POST['edit_id'])) {	
        $party_name = ""; $party_name_error = "";  $mobile_number = ""; $mobile_number_error = ""; $district = ""; $district_error = ""; $others_city = ""; $others_city_error = "";   $pincode_error = ""; $pincode = ""; $identification = ""; $identification_error = ""; $address = ""; $address_error = ""; $state = ""; $state_error = ""; $city = ""; $city_error = "";$party_error="";$valid_party = ""; $form_name = "party_form"; $party_type = 2;
            ...
            if(preg_match("/^\d+$/", $check_user_id_ip_address)) {
                ...
                if(empty($edit_id)) {
                    if(empty($prev_party_id)) {
                        ...
                        $null_value = $GLOBALS['null_value'];
                        $columns = array('created_date_time','updated_date_time', 'creator', 'creator_name','bill_company_id', 'party_id','party_type', 'party_name', 'mobile_number', 'name_mobile_city', 'address', 'state', 'district', 'city', 'party_details','lower_case_name','pincode','others_city','gst_number', 'email', 'deleted');
                        $values = array($created_date_time, $updated_date_time, $creator, $creator_name,$bill_company_id, $null_value,$party_type, $party_name, $mobile_number, $name_mobile_city, $address, $state, $district, $city, $party_details,$lower_case_name,$pincode,$others_city,$gst_number, $email,0);
                    ...
                    if(empty($prev_party_id) || $prev_party_id == $edit_id) {
                        ...
                        if(preg_match("/^\d+$/", $getUniqueID)) {
                            ...
                            $columns = array('updated_date_time','creator_name','party_name', 'mobile_number', 'name_mobile_city', 'address', 'state', 'district', 'city', 'party_details','lower_case_name','others_city','gst_number', 'email', 'party_type', 'pincode');
                            $values = array($updated_date_time,$creator_name, $party_name, $mobile_number, $name_mobile_city, $address, $state, $district, $city, $party_details,$lower_case_name,$others_city,$gst_number, $email, $party_type, $pincode);
    ...
    if(isset($_POST['draw'])){
        ...
        $totalRecords = 0;
        $totalRecords = count($obj->getpartyList($row, $rowperpage, $order_column, $order_direction, $search_text, $filter_party_id));
        $filteredRecords = count($obj->getpartyList('', '', $order_column, $order_direction, $search_text, $filter_party_id));

        $data = [];

        $partyList = $obj->getpartyList($row, $rowperpage, $order_column, $order_direction,$search_text, $filter_party_id);

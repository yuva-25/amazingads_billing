...
<head>
    <meta charset="utf-8">
    <title>Dashboard | Amazing Ads</title>
                ...
                <div class="col-lg-12">
                    <div class="text-center mt-sm-4 text-white-50">
                        <a href="index.php" class="d-inline-block auth-logo">
                           <img src="images/logo.webp" class="img-fluid" alt="Amazing Ads" title="Amazing Ads">
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body p-3">
                            <div class="text-center mt-2">
                                <h5 class="text-danger">Welcome Back !</h5>
                                 <p class="text-muted">Sign <?php if(!empty($users_count)) { ?>in<?php } else { ?>up<?php } ?> to continue to Amazing ads Billing.</p>
                            </div>
                            <div class="p-2 mt-4">
